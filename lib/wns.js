...
var templateSpecs = {
	...
	TileWideText11: [0, 10],
	TileSquareImage: [1, 0],
    TileSquare71x71Image: [1, 0],
    TileSquare71x71IconWithBadge: [1, 0],
    TileSquare150x150Image: [1, 0],
...
var createTemplate = function (type) {
	...
	return '<' + type + '%s><visual%s version="3">%s</visual>%s</' + type + '>';
};
